...
export const Header = () => {
  const initialState = { showNotification: false, showProfile: false };
  const [state, dispatch] = useReducer(reducer, initialState);

  function reducer(state, action) {
    switch (action.type) {
      case 'toggleNotification':
        return { showNotification: !state.showNotification };
      case 'toggleProfile':
  ...
  return (
    <header className="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
      <div className="container flex items-center justify-between h-full px-6 mx-auto text-green-600 dark:text-purple-300">
        <div>
        ...
        <div className="flex justify-center flex-1 lg:mr-32">
          <div className="relative w-full max-w-xl mr-6 focus-within:text-purple-500">
            ...
            <input
              className="w-full pl-8 pr-2 text-sm text-gray-700 placeholder-gray-600 bg-gray-100 border-0 rounded-md dark:placeholder-gray-500 dark:focus:shadow-outline-gray dark:focus:placeholder-gray-600 dark:bg-gray-700 dark:text-gray-200 focus:placeholder-gray-500 focus:bg-white focus:border-grey-300 focus:outline-none focus:shadow-outline-grey form-input"
              type="text"
        ...
        <ul className="flex items-center flex-shrink-0 space-x-6">
          <li className="relative">
            <button
              ...
              aria-haspopup="true"
              onClick={() => dispatch({ type: 'toggleNotification' })}
            >
              <svg
                className="w-5 h-5"
                aria-hidden="true"
